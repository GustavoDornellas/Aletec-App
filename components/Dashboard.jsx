...
import { listProducts, primeProductCache } from '@/lib/inventory-store';
export default function Dashboard() {
    ...
    return (<motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="p-4 md:p-8 space-y-6 md:space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {stats.map((stat, i) => (<div key={i} className="bg-white rounded-2xl p-5 md:p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow dark:bg-[#2b2927] dark:border-[#45413c]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-7 bg-white rounded-2xl p-6 shadow-sm border border-slate-100 dark:bg-[#2b2927] dark:border-[#45413c]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            return (<div key={i} className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-4 dark:border-[#45413c] dark:bg-[#242220]">
        ...
        <div className="lg:col-span-5 bg-white rounded-2xl p-6 shadow-sm border border-slate-100 dark:bg-[#2b2927] dark:border-[#45413c]">
          ...
          <div className="space-y-3">
            {recentProducts.length > 0 ? (recentProducts.map((product) => (<div key={product.id} className="flex items-center justify-between gap-4 rounded-2xl border border-slate-100 bg-slate-50/70 px-4 py-3 dark:border-[#45413c] dark:bg-[#242220]">
                ...
                </div>))) : (<div className="rounded-2xl border border-dashed border-slate-200 px-4 py-8 text-center text-sm text-slate-500 dark:border-[#4b4741] dark:text-blue-300/70">
